# Poem English titles — provenance

The English title shown for each poem (in `ghostty-shaders list poems`, the
gallery tooltips, and `collections/poems.titles`) was chosen to be the most
**recognizable published** English name. Where a poem has a clear canonical
title — an English Wikipedia article, or Witter Bynner's *The Jade Mountain* /
許淵沖 (Xu Yuanchong) in the standard *Three Hundred Tang Poems* anthologies —
that title (or a concise form of it) is used. Where several renderings compete
with no single dominant one (common for cí named by tune, and for less-
anthologized pieces), the most recognizable concise form is kept and marked
*no single standard*.

These are display labels, not full citations, so long anthology titles are
shortened. Classical poems have no single "official" English title; this table
records what was used and why.

| Scene | Poem | English title used | Basis |
| --- | --- | --- | --- |
| jing-ye-si | 靜夜思 | Quiet Night Thoughts | [Wikipedia](https://en.wikipedia.org/wiki/Quiet_Night_Thought) ("Quiet Night Thought"); plural form is the common one. Xu Yuanchong: "A Tranquil Night". |
| chun-jiang-hua-yue-ye | 春江花月夜 | The Moon over the River on a Spring Night | [Wikipedia](https://en.wikipedia.org/wiki/The_Moon_over_the_River_on_a_Spring_Night) article + Xu Yuanchong. (Replaced the literal "Spring River, Flower, Moon, Night".) |
| ba-jiu-wen-yue | 把酒問月 | Asking the Moon, Cup in Hand | No single standard. Distinct from 月下獨酌 ("Drinking Alone under the Moon") — deliberately not conflated. |
| jiang-xue | 江雪 | River Snow | Standard rendering; Bynner "River-Snow". |
| ye-xue | 夜雪 | Night Snow | No single standard; most common rendering. |
| bai-xue-ge | 白雪歌送武判官歸京 | Song of White Snow, Seeing Off Adjutant Wu | Concise form of Bynner's "A Song of White Snow in Farewell to Field-Clerk Wu Going Home" ([Jade Mountain](https://en.wikisource.org/wiki/The_Jade_Mountain/A_Song_of_White_Snow_in_Farewell_To_Field-Clerk_Wu_Going_Back_to_the_Capital)). |
| feng-xue-su | 逢雪宿芙蓉山主人 | Caught in Snow, Lodging at Lotus Mountain | No single standard (芙蓉 also "Hibiscus"). |
| wang-lushan-pubu | 望廬山瀑布 | Gazing at the Lushan Waterfall | Concise; Xu Yuanchong "The Waterfall in Mount Lu Viewed from Afar", also "Cataract on Mount Lu". |
...
is marked *no single standard* rather than asserted.
